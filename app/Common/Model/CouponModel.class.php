...
class CouponModel extends Model
{
    ...
    public function 取得新用户大礼包($user_id)
    {
        ...
        // ===================================================================================
        // 新大礼包100元大礼包
        $couponArr = $this->获得满减券(49, 10, 6, 7, 0, '', '新人券-通用-49-10');
        $coupon = array_merge($coupon, $couponArr);

        $couponArr = $this->获得满减券(99, 20, 4, 7, 0, '', '新人券-通用-99-20');
        $coupon = array_merge($coupon, $couponArr);

        $couponArr = $this->获得满减券(199, 25, 2, 7, 0, '', '新人券-通用-199-25');
        $coupon = array_merge($coupon, $couponArr);

        $couponArr = $this->获得满减券(299, 30, 2, 7, 0, '', '新人券-通用-299-30');
        $coupon = array_merge($coupon, $couponArr);
        ...
        $couponArr = $this->获得满减券(49, 10, 6, 7, 7, '', '新人券-通用-49-10');
        $coupon = array_merge($coupon, $couponArr);

        $couponArr = $this->获得满减券(99, 20, 4, 7, 7, '', '新人券-通用-99-20');
        $coupon = array_merge($coupon, $couponArr);

        $couponArr = $this->获得满减券(199, 25, 2, 7, 7, '', '新人券-通用-199-25');
        $coupon = array_merge($coupon, $couponArr);

        $couponArr = $this->获得满减券(299, 30, 2, 7, 7, '', '新人券-通用-299-30');
        $coupon = array_merge($coupon, $couponArr);
