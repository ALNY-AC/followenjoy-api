...
<head>
    ...
    <style>
        .coupon-card {
            background-image: url(/Public/Assets/images/card-bg.png)
        }
    </style>
</head>
...
<body>
    ...
    <div class="header">
        ...
        <img class="header-bg" src="/Public/Assets/images/fx_bg.png" alt="">
    </div>
    ...
    <div id="App">
        <div class="app-body" :style="[{opacity:opacity}]">
            ...
            <div class="coupon-bottom-info-box" v-if="isLogin()">
                ...
                <a href="followenjoy://abc" class="big-btn">
                    <div>
                        <img class="icon" src="/Public/Assets/images/logo.png" alt=""> 打开随享季
                    </div>
                </a>
            </div>
