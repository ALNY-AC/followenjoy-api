...
class SmsDemo
{
    ...
    */
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIA57f2T7ovKh8"; // AccessKeyId
        $accessKeySecret = "YcF2Qx3I6l8NUCOMbd5ynlVUpCE4aJ"; // AccessKeySecret
    ...
    */
    public static function sendSms($phone,$code) {
        ...
        $request->setSignName("随享季");
        
        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_134165129");
